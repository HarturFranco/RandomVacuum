...
def RandomAgentProgram(actions):
    ...
    True
    """
    # return lambda percept: 'Suck' if percept[1] else print(random.choice(actions))
...
def RandomVacuumAgent():
    ...
    True
    """
    return Agent(RandomAgentProgram(['Right', 'Left', 'Top', 'Down', 'Suck', 'NoOp']))
...
# ______________________________________________________________________________
# OurVacuumEnvironment :)
    
    
class OurVacuumEnvironment(Environment):
    """This environment has four locations, A and B, C and D. Each can be Dirty
